...
public abstract class AnguloBase extends Activity implements SensorEventListener
{
  ...
  protected SensorManager sensorManager;
    //Zeitsumme fuer Bufferung wahrend Messung siehe Klasse TriAngulo
    protected long SumTime;
    protected float[] Buffer; // Buffer fuer Messwerte
    // daraus wird der Integral-Mittelwert spaeter berechnet
    // und dieser wird fuer Berechnung der Laenge/Hoehe herangezogen
    protected long TimeStampBeginn; // Zeitstempel Beginn Bufferung
    protected int zaehler; // Zaehler fuer Anzahl Messungen
    protected boolean ErsteMessung;//=true wenn Erste Messung
    protected long TimeStamp; //Zeitstempel letzte Messung
  ...
  public void onCreate (Bundle savedInstanceState)
  {
    ...
    protected void createact(){
	// Part of create Activity
  ...
  public void onResume ()
  {
    ...
    protected void resumeact(){
	// onResume() Activity: can be called from extern
	    setOrientation ();
  ...
  public void onStop ()
  {
	...
	// onStop Activity can be called from extern
	for (int type : sensorTypes)
	    {
		Sensor sens = sensorManager.getDefaultSensor (type);
  ...
  public void onSensorChanged (SensorEvent evt)
  {
	  ...
	  TimeStampBeginn = evt.timestamp;
      }
      DeltaTime = evt.timestamp - TimeStamp;
      TimeStamp = evt.timestamp;     
        ...
        if (smoothGrav != null)
          {
            ...
            newDirectionValue (type, evt.values, DeltaTime);
          }
        break;
